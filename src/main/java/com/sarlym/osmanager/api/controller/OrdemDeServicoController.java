...
public class OrdemDeServicoController {
    ...
    public OrdemServicoDTO associarServico(@PathVariable(name = "id") Long id, @RequestBody ServicoRequest servicoRequest) {
        return ordemServicoMapper.modeloParaDTO(ordemServicoService.adicionaServico(id, servicoRequest));
    }
}
